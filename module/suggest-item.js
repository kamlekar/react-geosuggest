...
var SuggestItem = function (_React$Component) {
  ...
  _createClass(SuggestItem, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames3.default)('geosuggest__item', this.props.className, { 'geosuggest__item--active': this.props.isActive }, _defineProperty({}, this.props.activeClassname, this.props.activeClassname ? this.props.isActive : null));
      ...
      return _react2.default.createElement(
        ...
        function () {
          if (_this2.props.suggest.structured_formatting) {
            return _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(
                'div',
                null,
                _this2.props.suggest.structured_formatting.main_text
              ),
              _react2.default.createElement(
                'div',
                null,
                _this2.props.suggest.structured_formatting.secondary_text
              )
            );
          }
          return _this2.props.suggest.label;
        }()
      );
    }
  }]);
